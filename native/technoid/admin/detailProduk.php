...
<div class=" detail-produk p-3 mt-3 bg-primary text-light ">
    ...
    <div class="card w-100 text-dark my-3" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush">
            <li class="list-group-item">Harga : USD<?= number_format($produk['produk']->harga, 0) ?></li>
                ...
                <div class="row">
                    <div class="form-group mx-2 col-sm-5 ">
                        ...
                        <select class="form-control " name="kategori" id="">
                            <option>--Pilih--</option>
                            <option value="Ponsel">Basic</option>
                            <option value="Laptop">Sholatobu</option>
                            <option value="Komputer">Advanced</option>
                        </select>
                    </div>
                    <div class="form-group mx-2 col-sm-5 ">
