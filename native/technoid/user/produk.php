...
<div class="row mt-5">
    <div class="col py-3">
        <h4 class="text-uppercase text-center">Pilih paket terbaik untuk bisnis Anda. Ubah paket seiring pertumbuhan bisnis Anda.</h4>
    </div>
</div>
<!-- Produk Baru -->
<div class="row border-top justify-content-center">
    <?php foreach ($produk as $value) : ?>
        <div class="col-sm-3 my-2 card shadow-sm bg-white mx-2">
