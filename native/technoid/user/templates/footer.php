        ...
        <div class="row px-5 py-3">
            <div class="col-sm ">
                ...
                <p class="foot-item ml-3">
                    <a href="<?= url ?>user/produk.php/?kategori=ponsel">Basic</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=laptop">Sholatobu</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=komputer">Advanced</a><br>
                </p>
            </div>
            <div class="col-sm ">
                <h6>Halaman</h6>
